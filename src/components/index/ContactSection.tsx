...
const ContactSection: React.FunctionComponent = () => {
  ...
  const handleSubmit = (e: any) => {
    ...
    if (info.name === "") {
      ...
      setTimeout(() => {
        setLoading(false);
        setInfo({ name: "", email: "", phone: "", message: "", subject: "" });
        setSuccess(true);
          ...
          <div className="col-xl-6 col-lg-7">
            <div className="contact-wrapper mb-30">
              ...
              <p className="mb-55 wow fadeInUp" data-wow-delay=".4s">
                Leave us a message, we will responde within 24 hours through
                email
              </p>
              <form onSubmit={handleSubmit} className="contact-form">
                ...
                <button disabled={loading} type="submit" className="theme-btn theme-btn-2">
