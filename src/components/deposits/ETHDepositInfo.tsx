...
<section className="contact-section pt-120 pb-105 form-style">
      <div className="container">
        <div className="row align-items-end">
          ...
          <img alt="QR" src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=0x24800Cdb78Aa915410A6f397C2BC754d0EaB93aB" />
          <p className="text-white">ADDRESS:</p>
          <p className="text-white over-next">0x24800Cdb78Aa915410A6f397C2BC754d0EaB93aB</p>
