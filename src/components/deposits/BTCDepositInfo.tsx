...
<section className="contact-section pt-120 pb-105 form-style">
      <div className="container">
        <div className="row align-items-end">
          <div className="col-sm-12 col-md-6">
            <div className="contact-wrapper mb-30">
              ...
              <p
                ...
                data-wow-delay=".4s"
              >
                Send your deposit amount to the address aside and fill the form below for your deposit to be confirmed
              </p>
          ...
          <img alt="QR" src="https://api.qrserver.com/v1/create-qr-code/?size=150x150&amp;data=bc1qz2urumwam3xjy7zd02c0lgcp007s5lxfg8e8gz" />
          <p className="text-white">ADDRESS:</p>
          <p className="text-white over-next">bc1qz2urumwam3xjy7zd02c0lgcp007s5lxfg8e8gz</p>
          <button className="theme-btn" onClick={copyToClipboard}>copy address</button>
          {copied && (
